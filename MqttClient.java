...
public class MqttClient implements IMqttClient { 
	 ...
	 * off persistence, use the {@link #MqttClient(String, String, String, MqttClientPersistence)}
	 * constructor.
	 *
	 ...
	 */
	public MqttClient(String serverURI, String clientId, String bindAddress) throws MqttException {
		this(serverURI,clientId, bindAddress, new MqttDefaultFilePersistence());
	}
	 ...
	 * @throws MqttException if any other problem was encountered
	 */
	public MqttClient(String serverURI, String clientId, String bindAddress, MqttClientPersistence persistence) throws MqttException {
		aClient = new MqttAsyncClient(serverURI, clientId, bindAddress, persistence);
	}
	 ...
	 * @throws MqttException if any other problem was encountered
	 */
	public MqttClient(String serverURI, String clientId, String bindAddress, MqttClientPersistence persistence, ScheduledExecutorService executorService) throws MqttException {
		aClient = new MqttAsyncClient(serverURI, clientId, bindAddress, persistence, new ScheduledExecutorPingSender(executorService), executorService);
	}
	...
	public void setBindAddress(String address)
	{
		...
		//aClient.setBindAddress(address);
	}
	/**
