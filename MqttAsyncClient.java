...
public class MqttAsyncClient implements IMqttAsyncClient {
	 ...
	 */
	public MqttAsyncClient(String serverURI, String clientId, String bindAddress) throws MqttException {
	 ...
	 *             if any other problem was encountered
	 */
	public MqttAsyncClient(String serverURI, String clientId, String bindAddress, MqttClientPersistence persistence) throws MqttException {
		this(serverURI, clientId, bindAddress, persistence, new TimerPingSender());
	}

	public MqttAsyncClient(String serverURI, String clientId, String bindAddress, MqttClientPersistence persistence,
			MqttPingSender pingSender) throws MqttException {
		this(serverURI, clientId, bindAddress, persistence, pingSender, null);
	}
	...
	public MqttAsyncClient(String serverURI, String clientId, String bindAddress, MqttClientPersistence persistence,
		...
		this(serverURI, clientId, bindAddress, persistence, pingSender, executorService, null);
	}
	/**
	 * Create an MqttAsyncClient that is used to communicate with an MQTT
	 * server.
	...
	{
		//this.comms.setBindAddress(address);
	}
	...
	private NetworkModule createNetworkModule(String address, MqttConnectOptions options) throws MqttException, MqttSecurityException {
		...
		NetworkModule netModule = NetworkModuleService.createInstance(address, options, clientId, bindAddress);
